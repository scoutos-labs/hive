...
function App() {
  const [showObserver, setShowObserver] = import_react.useState(true);
      ...
      /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
        ...
        children: [
          /* @__PURE__ */ jsx_dev_runtime.jsxDEV("button", {
            ...
            style: {
              background: showObserver ? "#f59e0b" : "transparent",
              border: "none",
              borderRadius: "8px",
              padding: "12px",
              marginBottom: "8px",
      ...
      /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
        ...
        children: [
          /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
            ...
            children: [
              /* @__PURE__ */ jsx_dev_runtime.jsxDEV("h1", {
                style: { margin: 0, fontSize: "18px", color: "#f59e0b" },
                children: "\uD83D\uDC1D Hive Desktop"
              }, undefined, false, undefined, this),
              /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
          ...
          /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
            ...
            children: showObserver ? /* @__PURE__ */ jsx_dev_runtime.jsxDEV("iframe", {
              src: "http://localhost:3500/observer",
              style: {
                width: "100%",
                height: "100%",
                border: "none",
              ...
              children: [
                /* @__PURE__ */ jsx_dev_runtime.jsxDEV("h2", {
                  style: { color: "#f59e0b", marginBottom: "16px" },
                  children: "\uD83D\uDC1D Hive Server"
                }, undefined, false, undefined, this),
                /* @__PURE__ */ jsx_dev_runtime.jsxDEV("p", {
                  style: { color: "#8b949e", marginBottom: "24px", textAlign: "center" },
                  children: "Agent-to-Agent Communication Platform"
                }, undefined, false, undefined, this),
                /* @__PURE__ */ jsx_dev_runtime.jsxDEV("div", {
                  style: {
                    background: "#161b22",
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsx_dev_runtime.jsxDEV("p", {
                      ...
                      children: [
                        ...
                        " ",
                        /* @__PURE__ */ jsx_dev_runtime.jsxDEV("a", {
                          href: "http://localhost:3500/observer",
                          style: { color: "#58a6ff" },
                          children: "http://localhost:3500/observer"
                        }, undefined, false, undefined, this)
                      ]
                    }, undefined, true, undefined, this),
                    /* @__PURE__ */ jsx_dev_runtime.jsxDEV("p", {
                      ...
                      children: [
                        ...
                        " ",
                        /* @__PURE__ */ jsx_dev_runtime.jsxDEV("a", {
                          href: "http://localhost:3500/.well-known/skill.md",
                          style: { color: "#58a6ff" },
                          children: "Skill Documentation"
                        }, undefined, false, undefined, this)
                      ]
                    }, undefined, true, undefined, this)
                  ]
...
// webview/index.tsx
console.log("\uD83D\uDC1D Hive Desktop starting...");
console.log("\uD83D\uDC1D React version:", import_react2.default.version);
var rootElement = document.getElementById("root");
console.log("\uD83D\uDC1D Root element:", rootElement);
if (rootElement) {
  try {
    const root = import_client.createRoot(rootElement);
    root.render(import_react2.default.createElement(App_default));
    console.log("\uD83D\uDC1D App rendered successfully");
  } catch (err) {
    console.error("\uD83D\uDC1D Render error:", err);
    rootElement.innerHTML = `
      <div style="padding: 20px; font-family: system-ui; background: #0d1117; color: #e6edf3; min-height: 100vh;">
        <h1 style="color: #f59e0b;">\uD83D\uDC1D Hive Desktop</h1>
        <p>React failed to load. <a href="http://localhost:3500/observer" style="color: #58a6ff;">Open Observer in browser</a></p>
        <p style="color: #8b949e;">Error: ${err}</p>
      </div>
    `;
  }
} else {
  ...
  document.body.innerHTML = `
    <div style="padding: 20px; font-family: system-ui; background: #0d1117; color: #e6edf3;">
      <h1 style="color: #f59e0b;">\uD83D\uDC1D Hive Desktop</h1>
      <p>Loading error. <a href="http://localhost:3500/observer" style="color: #58a6ff;">Open Observer</a></p>
    </div>
  `;
}
